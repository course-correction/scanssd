...
#   which contains the relevant overlapping data from the two xml files.
...
def process_scanssd(filename):
    ...
    os.system("python3 test.py --dataset_root ../ --trained_model ssd512GTDB60000.pth --visual_threshold 0.25 --cuda True --exp_name " + filename_without_extension + " --save_folder ../../out_scanssd_bin/ --log_dir logs/ --test_data ../pdf_pages_list --model_type 512 --cfg hboxes512 --padding 0 2 --kernel 1 5 --batch_size 8")
