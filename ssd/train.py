# Sample command TODO Not updated for ages does not work
'''
python3 train.py --dataset GTDB
 --dataset_root /home/abhisek/Desktop/MathSeer-extraction-pipeline/modules/ScanSSD/gtdb_data
 --cuda True --visdom False --batch_size 8 --num_workers 8 --exp_name train1
 --model_type 512 --suffix _512 --cfg math_gtdb_512 --loss_fun fl
 --training_data /home/abhisek/Desktop/MathSeer-extraction-pipeline/modules/ScanSSD/test_two
 --kernel 1 5 --padding 0 2
Logging to logs/train1_1618708762.log
'''
...
def train(args):
    ...
    if args.resume:
        ...
        vgg_weights = torch.load("src/ScanSSD/ssd/base_weights/" + args.basenet)
    ...
    if not args.resume:
        ...
        torch.save(ssd_net.module.state_dict(),
                   os.path.join(
                       'src/ScanSSD/ssd/weights_' + args.exp_name, 'initial_' + str(args.model_type) + args.dataset + '.pth'))
    ...
    for epoch in range(cfg['max_epochs']):
        ...
        torch.save(ssd_net.module.state_dict(),
                   os.path.join(
                       'src/ScanSSD/ssd/weights_' + args.exp_name, 'ssd' + str(args.model_type) + args.dataset +
...
def init_args():
    ...
    if not os.path.exists("src/ScanSSD/ssd/weights_" + args.exp_name):
        os.mkdir("src/ScanSSD/ssd/weights_" + args.exp_name)
