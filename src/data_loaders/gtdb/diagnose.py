...
def read_data(training_pdf_names, char_dir, gt_math_dir, det_math_dir):
    ...
    for filename in training_pdf_names:
       ...
       #data_loaders = adjust_data[filename]
        ...
        with open(path, 'r') as csvfile:
            ...
            for row in reader:
                ...
                # row[2] = data_loaders[count][1]
                # row[3] = data_loaders[count][2]
                # row[4] = data_loaders[count][3]
                # row[5] = data_loaders[count][4]
...
if __name__ == '__main__':
    ...
    gt_math_dir = sys.argv[3]  # '/home/psm2208/data_loaders/GTDB/annotations/'

    gt_char_dir = sys.argv[4]#'/home/psm2208/data_loaders/GTDB/char_annotations/'
