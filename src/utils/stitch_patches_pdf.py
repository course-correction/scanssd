...
# for the directory paths, assumes it is being run from the src/ directory.
def parse_args():
    ...
    parser.add_argument('--exp_name', default='SSD',
                        help='Experiment name, output stored at [eval_dir]/[exp_name]/stitched_output/')
    ...
    parser.add_argument('--home_data', default='/home/psm2208/data_loaders/GTDB/', type = str,
                        help='database dir')
    parser.add_argument('--eval_dir', default='eval/', type = str,
                        help='eval directory')
    parser.add_argument('--home_images', default='/home/psm2208/data_loaders/GTDB/images/', type = str,
                        help='Images dir')
    parser.add_argument('--home_anno', default='/home/psm2208/data_loaders/GTDB/annotations/', type = str,
                        help='Annotations dir')
    parser.add_argument('--home_char', default='/home/psm2208/data_loaders/GTDB/char_annotations/', type = str,
                        help='Char anno dir')
...
def stitch(args):
    ...
    output_path = os.path.join(args.eval_dir, args.exp_name, "stitched_output")
    ...
    for ip, final_math in zip(voting_ip_list, out):
        ...
        try:
            ...
            math_file_path = os.path.join(output_path, pdf_name + '.csv')
