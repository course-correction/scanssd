...
train-example:
	./mprun-train --dataset GTDB --dataset_root quick_start_data --cuda True --visdom False --batch_size 2 --num_workers 4 --exp_name ScanSSD_XY_train --model_type 512 --suffix _512 --training_data file_lists/quick_start_train --cfg math_gtdb_512 --loss_fun ce --kernel 1 5 --padding 0 2 --neg_mining True --stride 0.05 --gpu 0
